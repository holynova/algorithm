...
function sortTest()
{
	...
	quick.quickSort(samples);
	// BubbleSort.prototype.bubbleSort(samples);
	// console.log(samples); 
	// insert_sort(samples);
	c.plot_arr(samples);
	CompareSortAlg(100, 10000);
...
function CompareSortAlg(times, N)
{
	...
	for (var i = 0; i < times; i++)
	{
		...
		//开始计时
		var start1 = new Date();
		// MergeSort.prototype.mergeSort4(arr);
		insert_sort(arr);
		...
		// 	return a - b;
		// });
		// QuickSort.prototype.quickSort(arr);
		...
		QuickSort.prototype.quickSort(arr2);
		// insert_sort(arr2);
		// select_sort(arr2);
...
function QuickSort()
{
	QuickSort.prototype.quickSort = function(arr)
	{
		...
		// var key = 0;
		QuickSort.prototype.sort(arr, 0, arr.length - 1);



	};

	QuickSort.prototype.sort = function(arr, lo, hi)
	{
		if (lo >= hi)
		{
			return;
		}
		var cur_key = QuickSort.prototype.partition(arr, lo, hi);
		QuickSort.prototype.sort(arr, lo, cur_key - 1);
		QuickSort.prototype.sort(arr, cur_key + 1, hi);
	};
	...
	QuickSort.prototype.unitTest = function()
	{
		var arr = genRandArr(8, 0, 9);
		// arr = [5, 3, 6, 2, 1, 8, 5];
		// arr = [2, 6, 2, 8, 1, 6, 4, 2];
		console.log(arr);
		// QuickSort.prototype.shuffle(arr);
		QuickSort.prototype.quickSort(arr);
		// QuickSort.prototype.partition(arr, 0, arr.length - 1);
		console.log(arr);
	};

	QuickSort.prototype.shuffle = function(arr)
	{
		var len = arr.length;
		for (var i = len - 1; i >= 0; i--)
		{
